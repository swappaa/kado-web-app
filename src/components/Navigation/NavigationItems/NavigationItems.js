...
const navigationItems = () => (
    <ul className="d-flex align-items-center">
        <NavigationItem link="/login" classes="d-flex flex-column align-items-center text-decoration-none text-center alerts-wrapper position-relative">
        ...
        <NavigationItem link="/login" classes="d-flex flex-column align-items-center text-decoration-none text-center">
        ...
        <NavigationItem link="/login" classes="d-flex flex-column align-items-center text-decoration-none text-center me-0">
        ...
        <li className="d-none">
            <a href="" className="d-flex align-items-center text-decoration-none theme-pink-bg-color text-white br-radius-40 font-ave-heavy fs-3 sign-up-btn">
                <span> Sign up</span>
            </a>
        </li>
        <li className="d-none">
