...
const KadosList = props => {
    ...
    const onGetAllKadosSent = useCallback(
        () => dispatch(actions.getAllKadosSent(token, username)),
        [dispatch]
    );

    console.log(allKadosRequests)
    console.log(allKadosSent)

    useEffect(() => {
        onGetAllKadosSent(token, username);
        onGetAllKadosRequests(token, username);
    }, [onGetAllKadosRequests, onGetAllKadosSent]);
                    ...
                    <div className="customs-wrapper w-100 mx-auto">
                        <ul className="nav nav-tabs bg-transparent" id="myTab" role="tablist">
                            <li className="nav-item" role="presentation">
                                <button className="nav-link active text-uppercase text-dark display-5" id="request-tab" data-bs-toggle="tab" data-bs-target="#request" type="button" role="tab" aria-controls="request" aria-selected="true">Kados Request</button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link text-uppercase text-dark display-5" id="sent-tab" data-bs-toggle="tab" data-bs-target="#sent" type="button" role="tab" aria-controls="sent" aria-selected="false">Kados I Sent</button>
                            </li>
                        </ul>
                        <div className="tab-content" id="kados">
                                                    ...
                                                    <td width="300">
                                                        <span className="display-6 text-uppercase status-wrapper">
                                                            {(() => {
                                                                ...
                                                                } else if (kados.status === 5) {
                                                                    return (
                                                                        <Aux>Declined</Aux>
                                                                    )
                                                                } else if (kados.status === 6) {
                                                                    return (
                                                                        <Aux>Completed</Aux>
                                                                    )
                                                                } else if (kados.status === 7) {
                                                                    return (
                                                                        <Aux>Cancelled</Aux>
                                                                    )
                                                                } else if (kados.status === 8) {
                                                                    return (
                                                                        <Aux>Timed Out</Aux>
                                                                    )
                                                                } else {
