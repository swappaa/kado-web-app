                        ...
                        <div className="customs-wrapper w-100 mx-auto">
                            <div className="dashboard-wrapper py-5">
                                ...
                                <div className="sec-wrapper-1 my-3 mb-5">
                                    <h5 className="card-header text-uppercase text-white rounded-0 fs-1 text-center py-3 mb-5">Requests</h5>
                                ...
                                <div className="sec-wrapper-2 my-3 mb-5">
                                    <h5 className="card-header text-uppercase text-white rounded-0 fs-1 text-center py-3 mb-5">Earnings</h5>
                                    <div className="card-group pb-3">
                                        <div className="card rounded-0 border-0 step-1">
                                        ...
                                        <div className="card rounded-0 border-0 step-3">
                                            <div className="chart-container" style={{ position: 'relative', width: '24vw' }}>
                                                <Pie
                                                    data={state}
                                                    options={{
                                                        responsive: true,
                                ...
                                <div className="sec-wrapper-3 my-3 mb-5">
                                    <h5 className="card-header text-uppercase text-white rounded-0 fs-1 text-center py-3 mb-5">Selected Charity</h5>
                                    <div className="card-group pb-3">
                                        <div className="card rounded-0 border-0 step-1">
                                            <div className="d-flex flex-wrap align-items-center justify-content-between h-100">
                                                <div className="text-start d-flex flex-row align-items-center justify-content-center column mb-4">
                                                    <div className="img-wrapper me-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="#58585a" width="48px" height="70px" viewBox="0 0 17.98 27.89"><title>pars equality center</title><g id="Layer_2" data-name="Layer 2"><g id="Talent_Dashboard-v1" data-name="Talent Dashboard-v1"><path className="cls-1" d="M10.09,14l3.29,3.68.57-.61c1.81-2,3.24-3.58,3.79-5.85A9.15,9.15,0,0,0,9.14,0,9,9,0,0,0,0,9.05c0,4.43,1.6,5.27,13.5,18.56a.82.82,0,0,0,.58.28h0a.82.82,0,0,0,.57-.24L17,25.33a.82.82,0,0,0,0-1.13C9.14,15.37,6,11.84,5.84,11.61a4,4,0,0,1-.68-4A4.13,4.13,0,0,1,9,4.91a4.14,4.14,0,0,1,4.09,4.14,4,4,0,0,1-.93,2.56c-.23.33-.86,1-2.06,2.39Z" /><path className="cls-1" d="M1,25.33,3.3,27.65a.83.83,0,0,0,.58.24h0a.81.81,0,0,0,.58-.28C5.71,26.24,6.85,25,7.89,23.84L4.56,20.17,1,24.2a.82.82,0,0,0,0,1.13Z" /></g></g></svg>
                                                    </div>
                                                ...
                                                <div className="text-start d-flex flex-row align-items-center justify-content-center column mb-4">
                                                    ...
                                                    <p className="card-title fs-1 lh-3 m-0">Contribution Level <b>10%</b></p>
                                                </div>
                                                <div className="text-start d-flex flex-row align-items-center justify-content-center column mb-4">
                                                    <p className="card-text theme-pink-color fs-3">
                                                        Donation Settings
                                                         <svg xmlns="http://www.w3.org/2000/svg" className="ms-2" fill="#ee2a59" width="20px" height="20px" viewBox="0 0 5.5 8.49"><title>arrow pink</title><g id="Layer_2" data-name="Layer 2"><g id="Talent_Dashboard-v1" data-name="Talent Dashboard-v1"><path className="cls-1" d="M0,1a.81.81,0,0,0,.33.5L3.29,4.24.35,7a.81.81,0,0,0-.33.5.82.82,0,0,0,.11.63.85.85,0,0,0,.71.39.9.9,0,0,0,.45-.13L5.15,4.92a.84.84,0,0,0,0-1.36L1.34.17l-.06,0A.76.76,0,0,0,.84,0,.84.84,0,0,0,.13.38.82.82,0,0,0,0,1Z" /></g></g></svg>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="sec-wrapper-4 my-3 mb-5">
                                    <h5 className="card-header text-uppercase text-white rounded-0 fs-1 text-center py-3 mb-5">Quick Settings</h5>
                                    <div className="card-group pb-3">
                                        <div className="card rounded-0 border-0 step-1">
                                            <div className="row g-3">
                                                <div className="col-2 quick-set-item rounded-circle d-flex flex-column align-items-center justify-content-center mb-3">
                                                    <div className="border-0 text-center p-2 position-relative">
                                                        <div className="img-wrapper">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="#58585a" width="80px" height="80px" viewBox="0 0 48.55 48.78"><title>record greeting</title><g id="Layer_2" data-name="Layer 2"><g id="Talent_Dashboard-v1" data-name="Talent Dashboard-v1"><path className="cls-1" d="M31.34,9v2.11h3.47V4.53a4.31,4.31,0,0,0-4.3-4.3v2a4.85,4.85,0,0,1-4.85,4.85H16a4.85,4.85,0,0,1-4.85-4.85v-2a4.31,4.31,0,0,0-4.3,4.3V21.37h2a4.73,4.73,0,0,1,1.8.35V9Z" /><path className="cls-1" d="M14,18.57c0,.45.28,3.84,1.58,4.63.08-.19.75-4.16,7.32-6.56,3.16-1.15,2.79,6.56,2.79,6.56,1-.46,1.38-2.7,1.52-4a10,10,0,0,1-2.6-6.1,7.82,7.82,0,0,0-4.23-1C16.19,12.26,13.78,14.55,14,18.57Z" /><path className="cls-1" d="M16,4h9.7a2,2,0,0,0,2-2V0H14V2a2,2,0,0,0,2,2Z" /><path className="cls-1" d="M34.52,22.5A9.87,9.87,0,0,1,31.34,22V38.22l-3.25-6.68A2.27,2.27,0,0,0,27,30.46l-2.9-1.62L23,27.52l-2.36,2.64-2.3-2.66L17,28.89l-2.8,1.58a2.24,2.24,0,0,0-.84.76,4.9,4.9,0,0,1,.36,1.84,4.85,4.85,0,0,1-2.48,4.23,5.22,5.22,0,0,1,.45.92,4.8,4.8,0,0,1,.32,1.7,4.85,4.85,0,0,1-4.85,4.85H6.83a4.31,4.31,0,0,0,4.29,4H30.51a4.31,4.31,0,0,0,4.3-4.3v-22Zm-10.24,22H17.42a1.42,1.42,0,0,1,0-2.84h6.86a1.42,1.42,0,1,1,0,2.84Z" /><path className="cls-1" d="M9.15,39.7a2,2,0,1,0-2,2A2,2,0,0,0,9.15,39.7Z" /><path className="cls-1" d="M4,21.14v-4H2a2,2,0,0,0,0,4Z" /><path className="cls-1" d="M8.86,28a2,2,0,0,0,0-4H3.72a2,2,0,1,0,0,4Z" /><path className="cls-1" d="M8.86,34.85a2,2,0,0,0,0-4H5.43a2,2,0,0,0,0,4Z" /><path className="cls-1" d="M47.13,22.59H43.89V18.37a4.66,4.66,0,0,0-4.67-4.66H27.55a7.16,7.16,0,0,0,7,5.72h1.71a1.42,1.42,0,0,1,1.42,1.42V41.7h1.53A4.67,4.67,0,0,0,43.89,37h3.24a1.42,1.42,0,0,0,1.42-1.43V24A1.41,1.41,0,0,0,47.13,22.59Z" /></g></g></svg>
                                                        </div>
                                                        <div className="py-1 pb-0 mt-2">
                                                            <p className="text-uppercase lh-1 theme-pink-color font-ave-heavy m-0">Record <br />Greeting</p>
                                                        </div>
                                                ...
                                                <div className="col-2 quick-set-item rounded-circle d-flex flex-column align-items-center justify-content-center mb-3">
                                                    <div className="border-0 text-center p-2 position-relative">
                                                        <div className="img-wrapper">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="
.35,12.84-3.5V13.07Z" /><path className="cls-1" d="M54.68,26a37.16,37.16,0,0,1-10.15,1.27,36.45,36.45,0,0,1-9.85-1.21,14.85,14.85,0,0,1-2.71-1L32,27.92v1c1,1.21,5.61,2.76,12.49,2.76a34.42,34.42,0,0,0,9.53-1.19c2.68-.82,3.27-1.67,3.27-1.84s.07-.29.07-.41h0V25A14.18,14.18,0,0,1,54.68,26Z" /><path className="cls-1" d="M54.1,20a34.42,34.42,0,0,0-9.57-1.18h-.21a34,34,0,0,0-8.86,1.05c-2.57.72-3.45,1.54-3.56,1.88a.11.11,0,0,0,0,.05l0,.05c.07.26.81,1.1,3.48,1.89a35,35,0,0,0,9.16,1.1A34.43,34.43,0,0,0,54,23.69c2.76-.82,3.38-1.67,3.39-1.86h0C57.37,21.63,56.75,20.81,54.1,20Z" /></g></g></svg>
                                                        </div>
                                                        <div className="py-1 pb-0 mt-2">
                                                            <p className="text-uppercase lh-1 theme-pink-color font-ave-heavy m-0">Booking <br />Fees</p>
                                                        </div>
                                                        <Link href="#" className="stretched-link"></Link>
                                                    </div>
                                                </div>
                                                <div className="col-2 quick-set-item rounded-circle d-flex flex-column align-items-center justify-content-center mb-3">
                                                    <div className="border-0 text-center p-2 position-relative">
                                                        <div className="img-wrapper">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="#58585a" width="80px" height="80px" viewBox="0 0 40.63 48.62"><title>get support</title><g id="Layer_2" data-name="Layer 2"><g id="Talent_Dashboard-v1" data-name="Talent Dashboard-v1"><path className="cls-1" d="M24.67,3.37V16.76a7.5,7.5,0,0,1-4.35,13.53,12.71,12.71,0,0,1-3.38,4.23,13.87,13.87,0,0,1-4.71,2.55,1.42,1.42,0,1,1-.75-2.74,11.62,11.62,0,0,0,3.73-2.08,9.8,9.8,0,0,0,2.18-2.52,7.49,7.49,0,0,1-1.64-13V4.16C7.63,7.07,3.15,13,4.29,23.31L1.35,28.25c-1,1.61-2.07,4.24-.67,5.51,1,.87,2.07.58,3,.87a21.08,21.08,0,0,0,2.82,7.65,4.47,4.47,0,0,0,4.42,2.19l2.8-.35.54,3.3a1.41,1.41,0,0,0,1.63,1.17l15,0a1.42,1.42,0,0,0,1.38-1.76c0-.06-1.24-5.53,2.45-13a36.71,36.71,0,0,1,2.6-4.33C39,27,40.62,24.3,40.63,21.33,40.65,12.27,33.45,4.76,24.67,3.37Z" /><path className="cls-1" d="M24.86,22.79a4.65,4.65,0,1,0-6.4,4.31,11.41,11.41,0,0,0,.33-2.79,1.43,1.43,0,1,1,2.85,0,13.94,13.94,0,0,1-.31,3A4.65,4.65,0,0,0,24.86,22.79Z" /><path className="cls-1" d="M18.6,1.43v14a7.49,7.49,0,0,1,3.23,0v-14A1.43,1.43,0,0,0,20.4,0H20A1.43,1.43,0,0,0,18.6,1.43Z" /></g></g></svg>
                                                        </div>
                                                        <div className="py-1 pb-0 mt-2">
                                                            <p className="text-uppercase lh-1 theme-pink-color font-ave-heavy m-0">Get <br />Support</p>
                                                        </div>
                                                        <Link href="#" className="stretched-link"></Link>
                                                    </div>
                                                </div>
