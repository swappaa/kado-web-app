                                ...
                                <div className="d-flex align-items-start">
                                    <div className="nav flex-column nav-pills me-3 position-relative" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <button className="btn nav-link text-start text-dark fs-2 d-flex align-items-center rounded-0" id="v-pills-payout-settings-tab" data-bs-toggle="pill" href="#v-pills-payout-settings" role="tab" aria-controls="v-pills-payout-settings" aria-selected="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="29px" height="30px" class="me-3" viewBox="0 0 22.86 15.71"><title>Payout Settings</title><g id="Layer_2" data-name="Layer 2"><g id="FAN_Settings" data-name="FAN Settings"><path class="cls-1" d="M22.86,3.71V2.5A2.5,2.5,0,0,0,20.36,0H2.5A2.5,2.5,0,0,0,0,2.5V3.71a.22.22,0,0,0,.22.22H22.63A.22.22,0,0,0,22.86,3.71Z" /><path class="cls-1" d="M0,5.58v7.63a2.5,2.5,0,0,0,2.5,2.5H20.36a2.5,2.5,0,0,0,2.5-2.5V5.58a.22.22,0,0,0-.23-.22H.22A.22.22,0,0,0,0,5.58Zm5.71,5.85a.71.71,0,0,1-.71.71H4.29a.71.71,0,0,1-.72-.71v-.72A.71.71,0,0,1,4.29,10H5a.71.71,0,0,1,.71.71Z" /></g></g></svg>
                                         Payout Settings
                                        </button>
                                        <button className="btn nav-link text-start text-dark fs-2 d-flex align-items-center rounded-0" id="v-pills-payment-credits-tab" data-bs-toggle="pill" href="#v-pills-payment-credits" role="tab" aria-controls="v-pills-payment-credits" aria-selected="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="29px" height="30px" class="me-3" viewBox="0 0 22.86 15.71"><title>Payments</title><g id="Layer_2" data-name="Layer 2"><g id="FAN_Settings" data-name="FAN Settings"><path class="cls-1" d="M22.86,3.71V2.5A2.5,2.5,0,0,0,20.36,0H2.5A2.5,2.5,0,0,0,0,2.5V3.71a.22.22,0,0,0,.22.22H22.63A.22.22,0,0,0,22.86,3.71Z" /><path class="cls-1" d="M0,5.58v7.63a2.5,2.5,0,0,0,2.5,2.5H20.36a2.5,2.5,0,0,0,2.5-2.5V5.58a.22.22,0,0,0-.23-.22H.22A.22.22,0,0,0,0,5.58Zm5.71,5.85a.71.71,0,0,1-.71.71H4.29a.71.71,0,0,1-.72-.71v-.72A.71.71,0,0,1,4.29,10H5a.71.71,0,0,1,.71.71Z" /></g></g></svg>
                                            Payments & Credits
                                        </button>
                                    ...
                                    <div className="tab-content w-50 mx-auto" id="v-pills-tabContent">
                                        ...
                                        <div className="tab-pane fade" id="v-pills-notifications" role="tabpanel" aria-labelledby="v-pills-notifications-tab">...</div>
                                        ...
                                        <div className="tab-pane fade" id="v-pills-payment-credits" role="tabpanel" aria-labelledby="v-pills-payment-credits-tab">...</div>
                                        <div className="tab-pane fade" id="v-pills-security-privacy" role="tabpanel" aria-labelledby="v-pills-security-privacy-tab">...</div>
                                        <div className="tab-pane fade" id="v-pills-tos" role="tabpanel" aria-labelledby="v-pills-tos-tab">...</div>
