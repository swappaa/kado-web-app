...
const SignUp = props => {
    ...
    let btnSubmit = <button
        ...
        type="submit" disabled={isAcceptTerms ? false : true}>SIGN UP</button>;
                ...
                <div className="signapp-modal" id="signapp-modal">
                    <div className="modal-content rounded-0 border-0">
                        <div className="modal-header px-5 border-0">
                            <h5 className="modal-title text-uppercase theme-pink-color display-4">Enter VERIFICATION CODE</h5>
                                            ...
                                            <form onSubmit={submitSignUpHandler}>
                                                ...
                                                <div className="form-check form-switch">
                                                    <input className="form-check-input" type="checkbox" id="flexSwitchCheckChecked"
                                                        onChange={termsConditionToggleClicked} checked={isAcceptTerms} />
